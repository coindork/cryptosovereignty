...
export const CRYPTO_CONFIG: ConstellationConfig = {
  ...
  colorBoth: 0x4ECDC4,
  colorBothCSS: '#4ECDC4',
  featuredNode: '01-cryptosovereignty',
  readingOrder: [
...
export const CHIRALITY_REMOTE_CONFIG: ConstellationConfig = {
  name: 'chirality',
  color: 0xF7931A,
  colorDim: 0xc47515,
  colorCSS: '#F7931A',
  ...
  readingOrder: [
    'the-constellation', 'the-handedness-of-being', 'theses-on-chirality',
    'the-five-completions', '05-the-filter', 'chirality-agamben',
    'care-can-now-be-proved', 'chirality', 'the-chiral-completion',
    'chiral-pedagogy', '06-dwelling-in-the-digital-age', 'the-proof-of-love',
    '11-the-event-of-logic', 'the-passage', 'tuesday-in-the-clearing', 'the-cete',
  ],
